...
public sealed class UpstreamSchemaValidator
{
    ...
    public UpstreamSchemaValidator(string contentRoot)
    {
        var scoreSchemaPath = Path.Combine(
            ...
            "BNK.RLVR.RVT.BSP.001.CURRENT_SCORE_RECOMPUTED.schema.json");
        ...
        _scoreSchema = LoadOrThrow(scoreSchemaPath, "BNK.RLVR.RVT.BSP.001.CURRENT_SCORE_RECOMPUTED");
        _tierSchema = LoadOrThrow(tierSchemaPath, "BNK.RLVR.RVT.BSP.001.TIER_UPGRADE_RECORDED");
