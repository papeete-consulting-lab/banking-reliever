workspace "Prescriber Referential (CAP.REF.001.PRE)" "Hold and maintain the canonical identity of prescribers and their organisations. Distinguishes prescriber types (banker, doctor, social worker) and their respective authorisations within the programme." {
    ...
    model {
        ...
        CAP_REF_001_PRE = softwareSystem "Prescriber Referential" "Hold and maintain the canonical identity of prescribers and their organisations. Distinguishes prescriber types (banker, doctor, social worker) and their respective authorisations within the programme." {
            ...
            properties {
                ...
                "adr:ADR-BCM-FUNC-0017" "https://github.com/Banking-PapeeteConsulting/reliever-knowledge/blob/main/func-adr/ADR-BCM-FUNC-0017-L2-REF001-PRE-prescriber-referential.md"
    ...
    views {
        systemContext CAP_REF_001_PRE "L2-Context" {
            include *
            autoLayout lr
        }
        container CAP_REF_001_PRE "L2-Containers" {
            include *
            autoLayout lr
        }
        styles {
