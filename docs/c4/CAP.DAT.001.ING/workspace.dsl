workspace "CAP.DAT.001.ING — Event Ingestion" "Collect and consolidate in decoupled analytics mode all behavioural events produced by the programme (BSP.001, BSP.002, BSP.003, BSP.004) to feed the analytics pipelines. Strict separation from the operational transactional pipeline." {
    ...
    model {
        ...
        CAP_DAT_001_ING = softwareSystem "Event Ingestion" "Collect and consolidate in decoupled analytics mode all behavioural events produced by the programme (BSP.001, BSP.002, BSP.003, BSP.004) to feed the analytics pipelines. Strict separation from the operational transactional pipeline." {
            ...
            properties {
                ...
                "adr:ADR-BCM-FUNC-0014" "https://github.com/Banking-Reliever/banking-knowledge/blob/main/func-adr/ADR-BCM-FUNC-0014-L2-DAT001-behavioural-analytics.md"
    ...
    views {
        systemContext CAP_DAT_001_ING "L2-Context" {
            include *
            autoLayout lr
        }
        container CAP_DAT_001_ING "L2-Containers" {
            include *
            autoLayout lr
        }
        styles {
