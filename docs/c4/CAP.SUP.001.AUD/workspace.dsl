workspace "Audit & Traceability (CAP.SUP.001.AUD)" "Log all accesses and actions on beneficiary data, across all capabilities. Cross-cutting capability: 100% of beneficiary data accesses must produce DataAccess.Logged — a GDPR regulatory obligation." {
    ...
    model {
        ...
        CAP_SUP_001_AUD = softwareSystem "Audit & Traceability" "Log all accesses and actions on beneficiary data, across all capabilities. Cross-cutting capability: 100% of beneficiary data accesses must produce DataAccess.Logged — a GDPR regulatory obligation." {
            tags "capability-self" "level:L2" "zone:SUP" "domain:generic"
            properties {
                ...
                "adr:ADR-BCM-FUNC-0012" "https://github.com/Banking-PapeeteConsulting/reliever-knowledge/blob/main/func-adr/ADR-BCM-FUNC-0012-L2-SUP001-data-compliance.md"
    ...
    views {
        systemContext CAP_SUP_001_AUD "L2-Context" {
            include *
            autoLayout lr
        }
        container CAP_SUP_001_AUD "L2-Containers" {
            include *
            autoLayout lr
        }
        styles {
