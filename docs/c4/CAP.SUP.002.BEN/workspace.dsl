    ...
    model {
        ...
        CAP_SUP_002_BEN = softwareSystem "Beneficiary Identity Anchor" "Hold the canonical beneficiary identity record, mint its UUIDv7 with a no-recycle-forever guarantee, and operate the GDPR Art. 17 pseudonymisation-at-anchor mechanics. Sole L2 of CAP.SUP.002. Relocated from CAP.REF.001 on 2026-05-15 per ADR-BCM-FUNC-0016 — golden record rule preserved." {
            ...
            properties {
                ...
                "adr:ADR-BCM-FUNC-0016" "https://github.com/Banking-Reliever/banking-knowledge/blob/main/func-adr/ADR-BCM-FUNC-0016-L2-SUP002-BEN-beneficiary-identity-anchor.md"
                "adr:ADR-TECH-TACT-002" "https://github.com/Banking-Reliever/banking-knowledge/blob/main/tech-adr/ADR-TECH-TACT-002-sup002-ben-beneficiary-identity-anchor.md"
                "adr:ADR-BCM-URBA-0001" "https://github.com/Banking-Reliever/banking-knowledge/blob/main/adr/ADR-BCM-URBA-0001-TOGAF-oriented-BCM-IS.md"
