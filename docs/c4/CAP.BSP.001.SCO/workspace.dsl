    ...
    model {
        ...
        CAP_BSP_001_SCO = softwareSystem "Behavioural Scoring" "Compute the beneficiary's behavioural score in real time from each transaction and incoming signal. The score is the sole source of truth for tier-change decisions, except for explicitly validated prescriber overrides." {
            ...
            properties {
                ...
                "adr:ADR-TECH-TACT-003" "https://github.com/Banking-Reliever/banking-knowledge/blob/main/tech-adr/ADR-TECH-TACT-003-bsp001-sco-behavioral-scoring.md"
                ...
                "adr:ADR-BCM-URBA-0007" "https://github.com/Banking-Reliever/banking-knowledge/blob/main/adr/ADR-BCM-URBA-0007-normalized-event-meta-model.md"
                "adr:ADR-BCM-URBA-0008" "https://github.com/Banking-Reliever/banking-knowledge/blob/main/adr/ADR-BCM-URBA-0008-event-modeling.md"
