workspace "Tier Referential (CAP.REF.001.TIE)" "Hold and maintain the canonical tier definitions: usage rules, transition thresholds, associated rights. Any modification goes through this L2 and triggers Tier.DefinitionUpdated, consumed in cascade by BSP.001, BSP.004 and B2B.001." {
    ...
    model {
        ...
        CAP_REF_001_TIE = softwareSystem "Tier Referential" "Hold and maintain the canonical tier definitions: usage rules, transition thresholds, associated rights. Any modification goes through this L2 and triggers Tier.DefinitionUpdated, consumed in cascade by BSP.001, BSP.004 and B2B.001." {
            tags "capability-self" "level:L2" "zone:REF" "domain:generic"
            properties {
                ...
                "adr:ADR-BCM-FUNC-0018" "https://github.com/Banking-PapeeteConsulting/reliever-knowledge/blob/main/func-adr/ADR-BCM-FUNC-0018-L2-REF001-TIE-tier-referential.md"
    ...
    views {
        systemContext CAP_REF_001_TIE "L2-Context" {
            include *
            autoLayout lr
        }
        container CAP_REF_001_TIE "L2-Containers" {
            include *
            autoLayout lr
        }
        styles {
